 ...
 * 
 * <p>Управляет тремя основными разделами:
 * <ul>
 *   <li>Калькулятор по закону Ома - расчет напряжения, тока или сопротивления</li>
 *   <li>Калькулятор делителя напряжения - поиск оптимальных комбинаций резисторов</li>
 *   <li>История операций - просмотр и поиск выполненных расчетов</li>
 * </ul>
 * 
 * <p>Все операции сохраняются в базе данных для последующего просмотра.
 * 
 * @author calc
 * @version 1.0
 */
