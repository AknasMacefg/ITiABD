...
public class CalcProcessesTest {
    ...
    public void testACalc() {
        ...
        // 100 мВ = 0.1 В, 1 МОм = 10 000 000 Ом, результат: 0.1 / 10 000 000 = 1e-8 А = 1e-5 мА
        String result3 = CalcProcesses.ACalc("100", "1", "МОм", "мА", "мВ");
        // Сравниваем численное значение, т.к. строковое представление может быть в экспоненциальной форме (1.0E-5).
        assertEquals(0.00001, Double.parseDouble(result3), 1e-10,
                "Ток должен быть 0.00001 мА");
    }
